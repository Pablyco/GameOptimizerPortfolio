...
void APortfolioCharacter::ExitGame()
{
	GetWorld()->GetFirstPlayerController()->ConsoleCommand("quit");
}

void APortfolioCharacter::OnAttack()
{
	if (Montage)
	{
...
void APortfolioCharacter::SetupStimulusSource()
{
...
void APortfolioCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Exit
		EnhancedInputComponent->BindAction(ExitAction, ETriggerEvent::Completed,this,&APortfolioCharacter::ExitGame);

		//Attack
		EnhancedInputComponent->BindAction(AttackAction,ETriggerEvent::Triggered, this,&APortfolioCharacter::OnAttack);
	}
